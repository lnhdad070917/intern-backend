...
-- AddForeignKey
ALTER TABLE `Sales` ADD CONSTRAINT `Sales_id_sales_item_fkey` FOREIGN KEY (`id_sales_item`) REFERENCES `Item`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Item` ADD CONSTRAINT `Item_id_customer_fkey` FOREIGN KEY (`id_customer`) REFERENCES `Customer`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
